...
public class FireBaseDataActivity extends AppCompatActivity {
    ...
    private EditText inputName, inputEmail,number;
        ...
        btnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(userId)) {
                    createUser(name, email,tnumber);
                } else {
                    updateUser(name, email,tnumber);
                }
            }
        });
    ...
    private void updateUser(String name, String email,String number) {
    ...
    public void getKeydata(){
        ...
        reference.orderByChild("mobile").equalTo("7030537378").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                for(DataSnapshot datas: dataSnapshot.getChildren()){
                    String familyname=datas.child("mobile").getValue().toString();
